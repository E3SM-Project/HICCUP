...
lev = ['1', '2', '3', '5', '7', '10', '20', '30', '50', '70', '100', '125', '150',
       '175', '200', '225', '250', '300', '350', '400', '450', '500', '550', '600', '650',
...
output_file_plv = f'{output_path}ERA5.atm.{yr_list[0]}-{mn_list[0]}-{dy_list[0]}.nc'
    ...
    server.retrieve('reanalysis-era5-pressure-levels',
                    {'product_type': 'reanalysis',
                     ...
                     'variable': ['temperature', 'specific_humidity', 'geopotential',
                                  ...
                                  'ozone_mass_mixing_ratio', 'specific_cloud_ice_water_content',
...
if get_sfc:
    server.retrieve('reanalysis-era5-single-levels',
                    {'product_type': 'reanalysis',
                     ...
                     'year': yr_list,
                     'format': 'netcdf',
                     'variable': ['surface_pressure', 'skin_temperature',
                                  'sea_surface_temperature', 'soil_temperature_level_1',
                                  'soil_temperature_level_2', 'soil_temperature_level_3',
                                  'soil_temperature_level_4', 'snow_depth',
                                  'temperature_of_snow_layer', 'orography', 'sea_ice_cover',
...
if get_lnd:
    server.retrieve('reanalysis-era5-land', {
        ...
        'variable': [
            ...
            'skin_reservoir_content', 'snow_albedo', 'snow_cover', 'snow_density',
