...
add_case('E3SM.2024-E3SM-tutorial-hindcast-21.2020-01-01',name='E3SM 21',root=tmp_root,c='green')
add_case('E3SM.2024-E3SM-tutorial-hindcast-22.2020-01-01',name='E3SM 22',root=tmp_root,c='green')
add_case('E3SM.2024-E3SM-tutorial-hindcast-23.2020-01-01',name='E3SM 23',root=tmp_root,c='green')
add_case('E3SM.2024-E3SM-tutorial-hindcast-24.2020-01-01',name='E3SM 24',root=tmp_root,c='green')
add_case('E3SM.2024-E3SM-tutorial-hindcast-25.2020-01-01',name='E3SM 25',root=tmp_root,c='green')
...
# add_case('E3SM.2024-E3SM-tutorial-hindcast-31.2020-01-01',name='E3SM 31',root=tmp_root,c='magenta')
# add_case('E3SM.2024-E3SM-tutorial-hindcast-32.2020-01-01',name='E3SM 32',root=tmp_root,c='magenta')
# add_case('E3SM.2024-E3SM-tutorial-hindcast-33.2020-01-01',name='E3SM 33',root=tmp_root,c='magenta')
# add_case('E3SM.2024-E3SM-tutorial-hindcast-34.2020-01-01',name='E3SM 34',root=tmp_root,c='magenta')
# add_case('E3SM.2024-E3SM-tutorial-hindcast-35.2020-01-01',name='E3SM 35',root=tmp_root,c='magenta')
...
fig_file,fig_type = 'fx_local','png'
...
for v,mvar in enumerate(sim_var_list):
  ...
  data_rf = data_an.isel(time=slice(time1,time2_ref))
  #-----------------------------------------------------------------------------
  # regional subset
  ...
  for c in range(num_case):
    ...
    for m in range(num_met):
      ...
      if metric_list[m]=='acc':
        ...
        # # print ACC values for debugging
        # for i in range(len(acc)):
        #   denom = ( denom_fc[i] * denom_an[i] )
        #   print(f'  acc: {acc[i]}  num: {acc_numerator[i]}  dnm: {denom}  dfc: {denom_fc[i]}  dan: {denom_an[i]}')
        # exit()
      #-------------------------------------------------------------------------
