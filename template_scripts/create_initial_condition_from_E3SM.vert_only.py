...
# dst_vert_grid,vert_file_name = 'L55',os.getenv('HOME')+f'/E3SM/vert_grid_files/L55_v2.nc'
...
### files for cases with topography
dst_horz_grid='ne4np4'  ; cami_file = f'{scratch_ic_path}/cami_mam3_Linoz_ne4np4_L72_c160909.nc'
dst_horz_grid='ne30np4' ; cami_file = f'{scratch_ic_path}/cami_mam3_Linoz_ne30np4_L72_c160214.nc'
dst_horz_grid='ne45np4' ; cami_file = f'{scratch_ic_path}/cami_mam3_Linoz_ne45np4_L72_c20200611.nc'
dst_horz_grid='ne120np4'; cami_file = f'{scratch_ic_path}/cami_mam3_Linoz_0000-01-ne120np4_L72_c160318.nc'

### default L72 files for aqua planet
# dst_horz_grid='ne4np4'  ; cami_file = f'{scratch_ic_path}/cami_aquaplanet_ne4np4_L72_c190218.nc'
# dst_horz_grid='ne30np4' ; cami_file = f'{scratch_ic_path}/cami_aquaplanet_ne30np4_L72_c190215.nc'
# dst_horz_grid='ne45np4' ; cami_file = f'{scratch_ic_path}/cami_aquaplanet_ne45np4_L72_c20200611.nc'

### default L72 files for RCE
# dst_horz_grid='ne4np4'  ; cami_file = f'{scratch_ic_path}/cami_rcemip_ne4np4_L72_c190919.nc'
# dst_horz_grid='ne30np4' ; cami_file = f'{scratch_ic_path}/cami_rcemip_ne30np4_L72_c190919.nc'
# dst_horz_grid='ne45np4' ; cami_file = f'{scratch_ic_path}/cami_rcemip_ne45np4_L72_c190919.nc'
...
if '_mam3_' in cami_file: output_atm_file_name = f'{data_root}cami_mam3_Linoz_{dst_horz_grid}_{dst_vert_grid}_c{timestamp}.nc'
if 'aquapl' in cami_file: output_atm_file_name = f'{data_root}cami_aqua_{dst_horz_grid}_{dst_vert_grid}_c{timestamp}.nc'
if 'rcemip' in cami_file: output_atm_file_name = f'{data_root}cami_rcemip_{dst_horz_grid}_{dst_vert_grid}_c{timestamp}.nc'
