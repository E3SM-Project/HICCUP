...
'''
ncpdq -U test_data/HICCUP_TEST.CAMS.atm.nc test_data/HICCUP_TEST.CAMS.atm.upack.nc
ncpdq -U test_data/HICCUP_TEST.CAMS.sfc.nc test_data/HICCUP_TEST.CAMS.sfc.upack.nc
'''

sfc_src_file_name = 'test_data/HICCUP_TEST.CAMS.sfc.upack.nc'
sfc_dst_file_name = 'test_data/HICCUP_TEST.CAMS.sfc.low-res.nc'

atm_src_file_name = 'test_data/HICCUP_TEST.CAMS.atm.upack.nc'
atm_dst_file_name = 'test_data/HICCUP_TEST.CAMS.atm.low-res.nc'

# ------------------------------------------------------------------------------
nlat_src,nlon_src = 241,480
